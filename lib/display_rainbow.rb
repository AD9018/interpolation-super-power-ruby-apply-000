...
puts "The third color in the rainbow is #{display_rainbows[2,yellow]}"
puts "The fourth color in the rainbow is #{display_rainbows[3,green]}"
puts "The fifth color in the rainbow is #{display_rainbows[4,blue]}"
